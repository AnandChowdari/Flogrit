...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden border-b border-border">
      <BackgroundGrid />
      <div className="relative mx-auto flex max-w-7xl flex-col gap-12 px-5 py-20 lg:flex-row lg:items-stretch lg:gap-0 lg:px-8 lg:py-28">
        <div className="relative z-10 flex flex-col justify-center lg:w-[54%] lg:pr-16">
          <motion.div
